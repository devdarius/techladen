...
const STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  processing: { label: 'In Bearbeitung',color: 'bg-purple-100 text-purple-800' },
...
export default function BestellungenPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <h1 className="text-2xl font-bold text-text-main mb-6">Meine Bestellungen</h1>
      ...
      {fetching ? (
        ...
        <div className="text-center py-16 bg-white rounded-card border border-border">
          ...
          <p className="font-medium text-text-main">Keine Bestellungen</p>
          <p className="text-sm text-text-secondary mt-1 mb-4">Du hast noch keine Bestellung aufgegeben.</p>
