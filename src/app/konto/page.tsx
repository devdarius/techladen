  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-text-main">Moje konto</h1>
          <p className="text-text-secondary text-sm mt-0.5">Witaj, {user.firstName}!</p>
        </div>
      ...
      <div className="bg-white rounded-card border border-border shadow-card overflow-hidden">
        {[
          { icon: Package, label: 'Moje zamówienia', sub: 'Historia i status zamówień', href: '/konto/zamowienia' },
          { icon: Settings, label: 'Dane konta', sub: 'Zmień hasło i dane osobowe', href: '/konto/ustawienia' },
